...
class IQANet(nn.Module):
    def __init__(self):
        ...
        self.up_2 = nn.Sequential(
            nn.ConvTranspose2d(in_channels=128+128, out_channels=128, kernel_size=3, stride=2, padding=1, output_padding=1, dilation=1),
            nn.ReLU(),
        )
...
##################### correct here ########################
# GPU_NUM: number of GPU you want to use (ex) "0", "2"
# dirname: folder directory where test images exist
# weights_file: file name of trained model weights
# result_score_txt: file name storing inference results
